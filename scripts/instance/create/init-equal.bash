...
GRANT SELECT, SHOW VIEW, LOCK TABLES, EVENT, TRIGGER ON *.* TO '${DB_BACKUP_USERNAME}'@'localhost';
FLUSH PRIVILEGES;
"

printf "$CREATE_BACKUP_USER_SQL_COMMANDS"
printf "DB_HOSTNAME: $DB_HOSTNAME | APP_USERNAME: $APP_USERNAME | APP_PASSWORD: $APP_PASSWORD"
