...
# Install Apache utilities (htpasswd), vnstat (bandwidth monitoring), PHP cli (for API), FTP service and gzip (backup)
apt-get install -y apache2-utils vnstat php-cli vsftpd gzip
