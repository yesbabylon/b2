...
switch(EXPORT_TYPE) {
    case 'FTP':
        exec('/usr/bin/php /home/docker/backup/ftp/import.php '.DOMAIN_NAME, $output , $return_var);
        break;
    case 'FS':
        exec('/usr/bin/php /home/docker/backup/fs/import.php '.DOMAIN_NAME, $output , $return_var);
        break;
}