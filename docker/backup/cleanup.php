...
switch(EXPORT_TYPE) {
    case 'FTP':
        exec('/usr/bin/php /home/docker/backup/ftp/cleanup.php '.DOMAIN_NAME, $output , $return_var);
        break;
    case 'FS':
        exec('/usr/bin/php /home/docker/backup/fs/cleanup.php '.DOMAIN_NAME, $output , $return_var);
        break;
}